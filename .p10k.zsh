# Generated by Powerlevel10k configuration wizard on 2020-05-05 at 12:03 IST.
...
# unicode, darkest, 12h time, angled separators, blurred heads, flat tails, 2 lines,
# solid, no frame, sparse, many icons, fluent, transient_prompt, instant_prompt=quiet.
